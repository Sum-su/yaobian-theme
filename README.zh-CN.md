...
一个 VS Code 扩展（`tombliboo0226.yaobian-theme`），把 [cherrycss.com](https://cherrycss.com)
...
在 VS Code 里搜 **窑变**（扩展 id `tombliboo0226.yaobian-theme`），或者：

```bash
code --install-extension tombliboo0226.yaobian-theme      # 从商城装
